...
describe('The CalendarUtils', () => {
  describe('The findWorkdaysInRange function', () => {
    ...
    it('returns the correct number of days when range is within the same week.', (done) => {
      const result = utils.findWorkdaysInRange(createStartDate(2015, 12, 14), createEndDate(2015, 12, 17), 11, 2015);
    ...
    it('returns zero when the range is outside the target expected month', (done) => {
      ...
      const result = utils.findWorkdaysInRange(createStartDate(2015, 12, 14), createEndDate(2015, 12, 17), 10, 2015);
    ...
    it('range contains a weekend', (done) => {
      ...
      const result = utils.findWorkdaysInRange(createStartDate(2015, 12, 10), createEndDate(2015, 12, 15), 11, 2015);
    ...
    it('short range contains a weekend', (done) => {
      ...
      const result = utils.findWorkdaysInRange(createStartDate(2015, 12, 11), createEndDate(2015, 12, 14), 11, 2015);
    ...
    it('range is one working day', (done) => {
      ...
      const result = utils.findWorkdaysInRange(createStartDate(2015, 12, 10), createEndDate(2015, 12, 10), 11, 2015);
    ...
    it('range is one Saturday', (done) => {
      ...
      const result = utils.findWorkdaysInRange(createStartDate(2015, 12, 19), createEndDate(2015, 12, 19), 11, 2015);
    ...
    it('range is one Sunday', (done) => {
      ...
      const result = utils.findWorkdaysInRange(createStartDate(2015, 12, 20), createEndDate(2015, 12, 20), 11, 2015);
    ...
    it('range is Saturday through Sunday', (done) => {
      ...
      const result = utils.findWorkdaysInRange(createStartDate(2015, 12, 19), createEndDate(2015, 12, 20), 11, 2015);
    ...
    it('range is 8 days / 6 working days', (done) => {
      // Target month is December (zero-based).
      const result = utils.findWorkdaysInRange(createStartDate(2015, 12, 15), createEndDate(2015, 12, 22), 11, 2015);
    ...
    it('range is 15 days / 11 working days', (done) => {
      ...
      const result = utils.findWorkdaysInRange(createStartDate(2015, 12, 1), createEndDate(2015, 12, 15), 11, 2015);
    ...
    it('range is the entire month', (done) => {
      ...
      const result = utils.findWorkdaysInRange(createStartDate(2015, 11, 1), createEndDate(2015, 11, 30), 10, 2015);
    ...
    it('range starts and ends outside of the month', (done) => {
      ...
      const result = utils.findWorkdaysInRange(createStartDate(2015, 10, 15), createEndDate(2015, 12, 5), 10, 2015);
    ...
    it('range starts outside the month', (done) => {
      ...
      const result = utils.findWorkdaysInRange(createStartDate(2015, 10, 31), createEndDate(2015, 11, 3), 10, 2015);
    ...
    it('range ends outside the month', (done) => {
      ...
      const result = utils.findWorkdaysInRange(createStartDate(2015, 11, 26), createEndDate(2015, 12, 3), 10, 2015);
